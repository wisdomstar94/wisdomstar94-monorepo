...
export function useApiAgainRequestScheduler(props?: IUseApiAgainRequestScheduler.Props) {
  ...
  const isStart = useRef<boolean | undefined>(undefined);
  ...
  function _processing(
    key: string,
    data: IUseApiAgainRequestScheduler.SaveApiItem & {
      key: string;
    } & Partial<{
        createdAt: number;
        updatedAt: number;
  ...
  function saveApi(
    items: IUseApiAgainRequestScheduler.SaveApiItem[],
    onSuccess?: () => void,
    onError?: (event: Event | undefined) => void
  ) {
  ...
  function holdApi(
    item: IUseApiAgainRequestScheduler.SaveApiItem,
    onSuccess: (item: IUseApiAgainRequestScheduler.SaveApiItem) => void,
    onError?: (event: Event | undefined) => void
  ) {
    indexeddbManager.insertToStore({
      dbName: 'api_again_request',
